...
void draw(SDL_Renderer* renderer,float w,float h) {  // Je pense que vous allez faire moins laid :)
    ...
    rectangle.x = w/2;                                             // x haut gauche du rectangle
    rectangle.y = h/2;                                                  // y haut gauche du rectangle
...
int main(int argc, char** argv) {
    ...
    draw(renderer,screen.w,screen.h);                                      // appel de la fonction qui crée l'image  
