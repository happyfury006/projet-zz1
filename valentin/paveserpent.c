...
int main(int argc, char* argv[]) {
    ...
    SDL_Window* window = SDL_CreateWindow("Animation avec SDL2", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, WINDOW_LARGEUR, WINDOW_HAUTEUR, 0);
    SDL_Renderer* renderer = SDL_CreateRenderer(window, -1, SDL_RENDERER_ACCELERATED);

    SDL_Rect rect = {0, (WINDOW_HAUTEUR - RECT_TAILLE) / 2, RECT_TAILLE, RECT_TAILLE};
